...
// --- CRITICAL FIX: IMPORT MANAGER SIDEBAR, NOT ADMIN ---
...
import { getStaffList, saveStaff, deleteStaff, getStaffDetails, recordPayment, updateLeaveStatus, createLeaveRequest } from "@/app/actions/staff-management"; 
...
interface StaffMember {
    ...
    email?: string;
    pin_code: string;
    status: 'online' | 'offline' | 'leave' | 'active';
    sales_today?: number;
    created_at?: string;
    salary?: number;
...
export default function StaffPage() {
  ...
  async function handleSaveStaff(e: React.FormEvent) {
      ...
      const data = {
          id: selectedStaff?.id, // ID present = Update
  ...
  async function handleDeleteStaff(id: string) {
      if(!confirm("Are you sure? This staff member will be permanently removed.")) return;
